    ...
    <main className="min-h-screen px-4 py-8 md:py-12 bg-zola-sky flex flex-col items-center gap-4">
      ...
      <section className="w-full max-w-3xl rounded-2xl border border-slate-200 bg-white shadow-card p-6 md:p-8">
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          <Link to="/register" className="h-11 px-6 rounded-lg bg-zola-blue text-white inline-flex items-center justify-center font-semibold hover:bg-blue-700 transition-colors">
            {t("register")}
          </Link>
          <Link to="/login" className="h-11 px-6 rounded-lg border border-zola-blue text-zola-blue inline-flex items-center justify-center font-semibold hover:bg-blue-50 transition-colors">
            {t("backToLogin")}
          </Link>
        </div>
      </section>
